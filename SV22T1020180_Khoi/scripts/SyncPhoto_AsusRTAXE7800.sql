/*
  Đồng bộ Photo: Router WiFi 6E Asus RT-AXE7800 — tham chiếu giá 6259606 (6.259.606).

  sqlcmd -S . -d LiteCommerceDB -E -f 65001 -i "...\SyncPhoto_AsusRTAXE7800.sql"
*/
...
DECLARE @ProductName NVARCHAR(255) = N'Router WiFi 6E Asus RT-AXE7800';
DECLARE @RefPrice      MONEY        = 6259606;
