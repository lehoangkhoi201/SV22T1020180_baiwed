/*
  Đồng bộ Photo: Xe điều khiển RC tốc độ cao — tham chiếu giá 7818551 (7.818.551).

  sqlcmd -S . -d LiteCommerceDB -E -f 65001 -i "...\SyncPhoto_XeDieuKhienRC.sql"
*/
...
DECLARE @ProductName NVARCHAR(255) = N'Xe điều khiển RC tốc độ cao';
DECLARE @RefPrice      MONEY        = 7818551;
