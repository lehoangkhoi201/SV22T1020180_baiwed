/*
  Đồng bộ Photo: Tai nghe HyperX Cloud III — tham chiếu giá 2915152 (2.915.152).

  sqlcmd -S . -d LiteCommerceDB -E -f 65001 -i "...\SyncPhoto_HyperXCloudIII.sql"
*/
...
DECLARE @ProductName NVARCHAR(255) = N'Tai nghe HyperX Cloud III';
DECLARE @RefPrice      MONEY        = 2915152;
