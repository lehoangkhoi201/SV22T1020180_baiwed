...
builder.Services.AddAuthentication(CookieAuthenticationDefaults.AuthenticationScheme)
                .AddCookie(option =>
                {
                    option.Cookie.Name = "SV22T1020180.Shop";
...
var mediaRoot = MediaStoragePaths.ResolveRoot(app.Environment, app.Configuration);
...
SV22T1020180.BusinessLayers.Configuration.Initialize(connectionString);
